    ...
    >
      ...
      <nav class="mt-10">
        <router-link
          ...
          :class="[$route.name === 'FasteyesHistory' ? activeClass : inactiveClass]"
          to="/fasteyes/history"
        >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4">歷史紀錄</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Attendance' ? activeClass : inactiveClass]"
          to="/fasteyes/attendance"
        >
          <svg
            class="w-5 h-5"
            viewBox="0 0 20 20"
          ...
          <span class="mx-4">考勤紀錄</span>
        </router-link>
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'AttendanceStatistics' ? activeClass : inactiveClass]"
          to="/fasteyes/attendance/statistics"
        >
          <svg
            class="w-5 h-5"
            viewBox="0 0 20 20"
          ...
          <span class="mx-4">考勤紀錄統計表</span>
        </router-link>
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Staff'||$route.name === 'StaffHistory' ? activeClass : inactiveClass]"
          to="/fasteyes/Staff"
        >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4">人員管理</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Department' ? activeClass : inactiveClass]"
          to="/fasteyes/Department"
        >
          ...
          <span class="mx-4">部門管理</span>
        </router-link> 

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'DataOutput' ? activeClass : inactiveClass]"
          to="/fasteyes/output"
        >
          ...
          <span class="mx-4">資料輸出</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'FasteyesDevice' ? activeClass : inactiveClass]"
          to="/fasteyes/Device"
        >
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
