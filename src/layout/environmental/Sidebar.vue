    ...
    >
      ...
      <nav class="mt-10">
        <router-link
          ...
          :class="[$route.name === 'TemperatureHumidity' ? activeClass : inactiveClass]"
          to="/environment/temperature_humidity"
        >
          <svg
            class="w-5 h-5"
            viewBox="0 0 20 20"
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'EnvironmentDeviceEmail' || 
                   $route.name === 'EnvironmentDeviceNitrogen' ||
                   $route.name === 'EnvironmentDeviceTemperatureHumidity' ? activeClass : inactiveClass]"
