      ...
      <div class="mt-4" >
        <div class="flex items-center px-4 py-4 space-x-4 overflow-x-auto bg-white rounded-md" style="background-color: #F5F6F9;">
          <div id="time" class="flex items-center justify-center">
            ...
            <input id="start_date" type="date" class="time_block_text" value="2021-12-10">
            <input id="start_time" type="time" class="time_block_text" value="00:00:00">
            <p> ~ </p>
            <input id="end_date" type="date" class="time_block_text" value="2021-12-11">
            <input id="end_time" type="time" class="time_block_text" value="12:00:00">
          </div>
          <div id="device" class="flex items-center justify-center">
            <select name="devices" class="device_block_text">
          ...
          <div id="setbutton" class="focus:outline-none focus:bg-indigo-500 flex items-center justify-center">
            ...
            <button class="device_comfirm_button">
                重置
            </button>
          </div>
        </div>
        ...
        <div class="flex items-center px-4 py-4 space-x-4 overflow-x-auto bg-white rounded-md" style="background-color: #F5F6F9;">
          ...
          <div id="switchbutton">
            <div class="focus:bg-indigo-500 flex items-center justify-center">
              <button class="device_all_button ">
                  全部
              </button>
              <button class="device_normal_button">
                  正常
              </button>
