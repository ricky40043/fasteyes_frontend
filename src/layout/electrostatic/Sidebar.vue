    ...
    >
      ...
      <nav class="mt-10">
        <router-link
          ...
          :class="[$route.name === 'ElectrostaticHistory' ? activeClass : inactiveClass]"
          to="/electrostatic/history"
        >
          <svg
            class="w-5 h-5"
            viewBox="0 0 20 20"
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'UnDetectStaff' ? activeClass : inactiveClass]"
          to="/electrostatic/UnDetectStaff"
        >
          <svg
            class="w-5 h-5"
            viewBox="0 0 20 20"
          ...
          <span class="mx-4">未測人員</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'ElectrostaticDevice' ? activeClass : inactiveClass]"
          to="/electrostatic/device"
        >
          <svg
            class="w-5 h-5"
            viewBox="0 0 20 20"
